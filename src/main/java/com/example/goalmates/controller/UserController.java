...
public class UserController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<UserSearchResultDTO>> search(@RequestParam("name") String name) throws IOException {
    ...
    @GetMapping("/")
    public ResponseEntity<UserFollowingDTO> getUserById(@RequestParam("id") Long id) throws IOException {
